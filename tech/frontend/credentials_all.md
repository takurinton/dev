...
head:
  ...
  - - meta
    - name: og:image
      content: https://res.cloudinary.com/dtapptgdd/image/upload/w_1000/l_text:Sawarabi Gothic_70_bold:credentials を指定した際に注意するべきこと/v1620370500/Screen_Shot_2021-05-07_at_15.54.47_extlvu.png
  - - meta
    - name: twitter:image
      content: https://res.cloudinary.com/dtapptgdd/image/upload/w_1000/l_text:Sawarabi Gothic_70_bold:credentials を指定した際に注意するべきこと/v1620370500/Screen_Shot_2021-05-07_at_15.54.47_extlvu.png
---
